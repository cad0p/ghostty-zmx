# ghostty-zmx session manager for zsh — FROZEN v0.1 fallback.
#
# This is the v0.1 manager (tag v0.1.3), shipped alongside the v0.2 manager.
# The v0.2 session-manager.zsh probes the hosting Ghostty for the 1.4.0
# tty/pid AppleScript terminal capability at shell init. On a Ghostty that
# lacks it (1.3.x), it early-sources THIS file and returns, so 1.3.x surfaces
# keep unchanged v0.1 behavior (local sessions only, focus-based identity).
# The remote features and tty-based identity are active only on Ghostty >= 1.4.
#
# Do NOT edit this file to add v0.2 features — it is frozen on purpose. v0.2
# changes go in session-manager.zsh only. Keeping v0.1 in its own file means v0.2
# never carries v0.1 branches and cannot regress it.
#

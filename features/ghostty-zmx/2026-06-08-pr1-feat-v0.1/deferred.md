...
- Phase 3 bloat review fixed cheap public-surface/stale-doc/runtime-cleanup bloat, deferred larger reaper/test refactors to v0.2, and post-fix bloat reviewers found no remaining fix-now bloat or unsafe over-trim.

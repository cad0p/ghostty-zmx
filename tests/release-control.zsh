...
grep -q 'pull-requests: read' "$workflow" || { print -u2 'release workflow pull-requests permission missing'; exit 1; }
grep -q -- '- main' "$workflow" || { print -u2 'release workflow main-branch trigger missing'; exit 1; }
